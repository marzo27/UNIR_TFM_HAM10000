...
# dashboard_gradio/utils/carga_metricas.py -> dashboard_gradio/utils -> dashboard_gradio -> UNIR_TFM_HAM10000
...
def _leer_json(ruta: Path) -> dict:
    if not ruta.exists():
        raise FileNotFoundError(
            ...
            f"Comprueba que la carpeta 'dashboard_gradio' esté dentro de UNIR_TFM_HAM10000."
        )
